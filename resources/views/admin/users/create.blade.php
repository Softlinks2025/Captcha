                    ...
                    <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="@error('password_confirmation') error @enderror" id="password_confirmation" name="password_confirmation" required>
                                <i class="fas fa-lock icon"></i>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="@error('phone') error @enderror" id="phone" name="phone" value="{{ old('phone') }}" required>
                            ...
                            <!-- Referrer's Code -->
                            <div class="form-group">
                                <label for="referral_code">Referrer's Code (Optional)</label>
                                <input type="text" class="@error('referral_code') error @enderror" 
                                       id="referral_code" 
                                       name="referral_code" 
                                       value="{{ old('referral_code') }}"
                                       placeholder="Enter the referrer's code">
                                <i class="fas fa-user-plus icon"></i>
                                <small>Enter the code of the user/agent who referred this new user</small>
                                @error('referral_code')
                                    <span class="error">{{ $message }}</span>
                                @enderror
                            </div>
                                ...
                                @else
                                    @foreach($roles as $id => $name)
                                        <div class="custom-checkbox">
                                            <input type="radio" id="role_{{ $id }}" name="roles[]" value="{{ $id }}" {{ $loop->first ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="additional_contact_number" id="additional_contact_number" class="form-control" value="{{ old('additional_contact_number') }}">
                            </div>
                            <div class="form-group">
