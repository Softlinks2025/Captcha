...
-->                <a href="{{ route('admin.subadmins.index') }}" class="nav-link active">Sub-Admin</a>
        ...
        <div class="main-content">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.subadmins.store') }}">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="role" name="role" required>
                                ...
                                <option value="push-subadmin">Push Notification Manager</option>
                                <option value="withdrawal-subadmin">Withdrawal Request Manager</option>
